...
namespace TimeLab.Systems {
	public sealed class WorldGenerator {
		...
		public void Generate() {
			...
			worldCommands.Enqueue(0, new AddLocationCommand(firstLocationId, new Rect2DInt(0, 0, 10, 6)));
			worldCommands.Enqueue(0, new AddLocationCommand(secondLocationId, new Rect2DInt(0, -7, 10, 6)));
